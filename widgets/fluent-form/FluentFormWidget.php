...
class rs__FluentFormWidget extends Widget_Base
{
    public function get_name()
    {
        return 'rs-fluent-form-widget';
    }

    public function get_title()
    {
        return __('RS Fluent Forms', 'rsaddon');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->register_field_icon_style_controls();
    ...
    protected function register_general_controls()
    {
        ...
        $this->add_control(
            'form_list',
            [
                'label'       => esc_html__('Fluent Forms', 'rsaddon'),
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Custom Title & Description', 'rsaddon'),
        ...
        $this->add_control(
            'field_icon_show_hide',
            [
                'label'       => __('Field Icon Show/Hide', 'rsaddon'),
                'type'        => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'flex' => __( 'Show', 'rsaddon'),
                    'none' => __( 'Hide', 'rsaddon'),   
                ],
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-input--content::before' => 'display: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'choose_color_scheme',
            [
                'label'       => __('Choose Color Scheme', 'rsaddon'),
                'type'        => Controls_Manager::SELECT,
                'label_block' => true,
                'options' => [
                    '' => __( 'Default Scheme', 'rsaddon'),
                    'primary_scheme' => __( 'Primary Scheme', 'rsaddon'),
                    'light_scheme' => __( 'Light Scheme', 'rsaddon'),
                    'dark_scheme' => __( 'Dark Scheme', 'rsaddon'),
                ],
                'default' => '',
            ]
        );
    ...
    protected function register_error_controls()
    {
        ...
        $this->add_control(
            'error_messages',
            [
                'label'        => __('Error Messages', 'rsaddon'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
                'label_on'     => __('Show', 'rsaddon'),
                'label_off'    => __('Hide', 'rsaddon'),
    ...
    protected function register_title_description_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label'     => __('Title & Description', 'rsaddon'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-title' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function register_form_container_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Form Container', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function register_label_style_controls()
    {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fluentform-widget-wrapper .ff-el-input--label label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
    ...
    protected function register_input_textarea_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Input & Textarea', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'form_textarea_width',
            [
                'label' => __('Textarea Width', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'  => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Textarea Height', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'  => 0,
        ...
        $this->add_responsive_control(
            'form_textarea_margin_bottom',
            [
                'label' => __('Textarea Margin Bottom', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'  => 0,
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group textarea' => 'margin-bottom: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
    ...
    protected function register_terms_gdpr_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('GDPR , Terms & Condition ', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function register_placeholder_style_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group input::placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group input::-webkit-input-placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group input:-ms-input-placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group textarea::placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group textarea::-webkit-input-placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group textarea:-ms-input-placeholder' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'placeholder_switch' => 'yes',
                ],
    ...
    protected function register_radio_checkbox_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Radio & Checkbox', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Custom Styles', 'rsaddon'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => __('Yes', 'rsaddon'),
                'label_off'    => __('No', 'rsaddon'),
                'return_value' => 'yes',
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ff-el-form-check label.ff-el-form-check-label',
			]
		);
    ...
    protected function register_section_break_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Section Break', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function register_field_icon_style_controls()
    {
        $this->start_controls_section(
            'section_form_field_icon',
            [
                'label' => __('Field Icon', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'field_icon_show_hide' => 'flex',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name'     => 'form_field_icon_typography',
                'label'    => __('Typography', 'rsaddon'),
                'selector' => '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-input--content::before',

            ]
        );

        $this->add_control(
            'form_field_icon_color',
            [
                'label'     => __('Color', 'rsaddon'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-input--content::before' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'form_field_icon_position_top',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-input--content::before' => 'top: {{SIZE}}{{UNIT}}; bottom: unset;',
                ],
            ]
        );
        
        $this->add_responsive_control(
            'form_field_icon_position_left',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-input--content::before' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                ],
            ]
        );
    ...
    protected function register_dropdown_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Dropdown', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->add_control(
            'form_dropdown_text_color',
            [
                'label'     => __('Color', 'rsaddon'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group select' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group.dropdown-icon .ff-el-input--content' => 'color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function register_checkbox_grid_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Checkbox Grid', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Grid Table Head', 'rsaddon'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Grid Table Item', 'rsaddon'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Odd Item Background Color', 'rsaddon'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
    ...
    protected function register_pagination_style_controls()
    {
        if (defined('FLUENTFORMPRO')) {
            ...
            $this->add_control(
                ...
                [
                    'label' => __('Progressbar Label', 'rsaddon'),
                    'type'  => Controls_Manager::HEADING,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'        => __('Show Progressbar', 'rsaddon'),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => __('Show', 'rsaddon'),
                    'label_off'    => __('Hide', 'rsaddon'),
                    'return_value' => 'yes',
    ...
    protected function register_submit_button_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Submit Button', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'input_block_flex',
            [
                'label' => esc_html__( 'Input (Block/Inline)', 'rsaddon' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex' => [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .frm-fluent-form .ff-t-container' => 'display: {{VALUE}};',
                ],
				'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            'form_submit_button_text_align',
            [
                'label'   => __('Text Alignment', 'rsaddon'),
                'type'    => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'rsaddon'),
                ...
                'default'      => '',
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff_submit_btn_wrapper .ff-btn-submit' => 'text-align: {{VALUE}}'
                ]
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'custom',
                'options' => [
                    'full-width' => __('Full Width', 'rsaddon'),
                    'custom'     => __('Custom', 'rsaddon'),
                ],
                'prefix_class' => 'fluentform-widget-submit-button-',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group .ff-btn-submit' => 'width: {{SIZE}}{{UNIT}}; min-width: {{SIZE}}{{UNIT}};', ],
                'condition' => [
                    'form_submit_button_width_type' => 'custom',
                ],
            ]
        ...
        $this->add_control(
            'form_submit_button_icon_show_hide',
            [
                'label'   => __('Icon Show Hide', 'rsaddon'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'flex' => __('Show', 'rsaddon'),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff_submit_btn_wrapper .ff-btn-submit:after' => 'display: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name'      => 'form_submit_button_icon_typography',
                'label'     => __('Icon Typography', 'rsaddon'),
                'selector'  => '{{WRAPPER}} .fluentform-widget-wrapper .ff_submit_btn_wrapper .ff-btn-submit:after',
                'condition' => [
                    'form_submit_button_icon_show_hide' => 'flex'
                ]
            ]
        );

        $this->add_control(
            'form_submit_button_icon_color',
            [
                'label'     => __('Icon Color', 'rsaddon'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff_submit_btn_wrapper .ff-btn-submit:after' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'form_submit_button_icon_show_hide' => 'flex'
                ]
        ...
        $this->add_responsive_control(
            'form_submit_button_icon_position_right',
            [
                'label'      => esc_html__('Icon Right', 'rsaddon'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range'      => [
                    '%' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff_submit_btn_wrapper .ff-btn-submit:after' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                ],
                'condition' => [
                    'form_submit_button_icon_show_hide' => 'flex'
                ]
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'separator' => 'before',
				'selectors' => [
					'{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group .ff-btn-submit' => 'position: {{VALUE}}; z-index: 1;',
				],
			]
		);
        $this->add_responsive_control(
            'form_submit_button_position_top',
            [
                'label' => __('Position Top', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => -1000,
                ...
                'condition' => [
                    'button_position_custom' => ['relative', 'absolute']
                ],
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group .ff-btn-submit' => 'top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'form_submit_button_position_right',
            [
                'label' => __('Position Right', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => -1000,
                ...
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group .ff-btn-submit' => 'right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'form_submit_button_position_bottom',
            [
                'label' => __('Position Bottom', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => -1000,
                ...
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group .ff-btn-submit' => 'bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'form_submit_button_position_left',
            [
                'label' => __('Position Left', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => -1000,
                ...
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group .ff-btn-submit' => 'left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'form_submit_button_move_x_icon',
            [
                'label' => __('Icon Move X', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'  => 0,
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group .ff-btn-submit i:before' => 'right: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff_submit_btn_wrapper .ff-btn-submit:after' => 'transform: translateX({{SIZE}}{{UNIT}})',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'form_submit_button_move_x_icon_hover',
            [
                'label' => __('Icon Move X Hover', 'rsaddon'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'  => 0,
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-el-group .ff-btn-submit:hover i:before' => 'right: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff_submit_btn_wrapper .ff-btn-submit:hover:after' => 'transform: translateX({{SIZE}}{{UNIT}})',
                ],
            ]
        );
    ...
    protected function register_success_message_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Success Message', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .ff-message-success' => 'color: {{VALUE}}!important',
                ],
            ]
        );
    ...
    protected function register_errors_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Error Message', 'rsaddon'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .fluentform-widget-wrapper .error.text-danger' => 'color: {{VALUE}}!important',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('fluentform_widget_wrapper', 'class', 'color_' . $settings['choose_color_scheme'] . '');
